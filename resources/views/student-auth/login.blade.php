    ...
    <div class="card mx-auto shadow-sm border-1 p-4 rounded-4" style="max-width: 450px;">
        <div class="card-body">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Sign in to access your student account.</p>
            </div>
            ...
            <form method="POST" action="{{ route('studentAuth.login.submit') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control bg-light border-0 py-2" placeholder="juan@email.com" value="{{ old('email') }}" required>
                </div>
                <div class="mb-3">
                ...
                <div class="text-end mb-4">
                    <a href="{{ route('studentAuth.forgotPassword') }}" class="text-decoration-none text-primary small fw-semibold">Forgot password?</a>
                </div>
            ...
            <div class="text-center mt-4 pt-3 border-top">
                ...
                <a href="{{ route('studentAuth.register') }}" class="text-primary text-decoration-none fw-bold small ms-1">Register here</a>
            </div>
        </div>
    </div>
</div>
