            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <h1 class="h3 fw-bold">
                        ...
                        {{ explode(' ', $student->full_name)[0] }}!
                    </h1>
                    <p class="text-muted">ID: {{ $student->email }}</p>
                </div>
                <form method="GET" action="{{ route('studentAuth.dashboard') }}" class="d-flex">
                    <div class="input-group">
                        <span class="input-group-text bg-white border-end-0"><i class="bi bi-search"></i></span>
                        <input type="text" name="search" class="form-control border-start-0"
                               placeholder="Search exams by title or subject…" value="{{ $search }}" />
                    </div>
                </form>
            </div>
                    ...
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <p class="text-muted small mb-0">Total Exams Available</p>
                                    <h3 class="fw-bold mb-0">{{ $totalExams }}</h3>
                                    <span class="text-muted small">Active this semester</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-muted small">Due this month</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title">
                                <i class="bi bi-pencil-square text-primary me-2"></i>Available Exams
                            </h5>

                            @if($availableExams->isEmpty())
                                <div class="text-center py-4 text-muted">
                                    <i class="bi bi-check-all fs-1"></i>
                                    <p class="mt-2 mb-0">All exams completed — great work!</p>
                                </div>
                            @else
                                        ...
                                        <tbody>
                                            @foreach($availableExams as $exam)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-secondary">{{ $exam->access_code }}</span>
                                                    </td>
                                                    <td>
                                                        {{-- You can either use the code entry form or directly link to start --}}
                                                        <a href="{{ route('studentExam.instructions', $exam->exam_id) }}" class="btn btn-sm btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#"
                               ...
                               onmouseout="this.classList.remove('bg-light')">
                                ...
                                <div>
                                    <p class="fw-bold text-dark mb-0">Enter Access Code</p>
                                    <p class="text-muted small mb-0">Take an exam instantly</p>
                                </div>
                            </a>

                            <a href="{{ route('student.results') }}" class="d-flex align-items-center gap-3 text-decoration-none p-3 border rounded-3"
                               onmouseover="this.classList.add('bg-light')"
                               onmouseout="this.classList.remove('bg-light')">
                                ...
                                <div>
                                    <p class="fw-bold text-dark mb-0">View All Results</p>
                                    <p class="text-muted small mb-0">{{ $examsTaken }} completed</p>
                                </div>
                            </a>
                        </div>
                    </div>
