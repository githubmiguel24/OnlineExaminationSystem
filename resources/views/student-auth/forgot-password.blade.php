...
<div class="container py-5" style="font-family: sans-serif;">
    <div class="mb-4 text-center">
        <a href="{{ route('studentAuth.login') }}" class="text-decoration-none text-muted"><i class="bi bi-arrow-left me-1"></i> Back to Login</a>
    </div>
    ...
    <div class="card mx-auto shadow-sm border-1 p-4 rounded-4" style="max-width: 450px;">
        <div class="card-body">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-muted small">Enter your email and a new secure password.</p>
            </div>
            ...
            <form method="POST" action="{{ route('studentAuth.forgotPassword.submit') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control bg-light border-1 py-2" placeholder="example@gmail.com" value="{{ old('email') }}" required>
                </div>
                <div class="mb-3">
